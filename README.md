...
```bash
git clone https://github.com/ishimwe5555/Locsent.git
cd Locsent
```
...
Developed by [Norbert Ishimwe](https://ishimwe.codes/)

Feel free to contribute or fork the project!

For any issues, feel free to ask [Norbert](mailto:ishimwe96@gmail.com). 😊 
